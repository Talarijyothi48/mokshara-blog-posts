    ...
    <div class="footer-founder-profiles">
      <div class="footer-founder-card">
        <div class="footer-avatar-container">
          <img src="https://mokshara.indevs.in/assets/jyothi.jpeg?v=1.3" alt="Jyothi Talari" class="footer-avatar" onerror="this.style.display='none'"/>
        </div>
        <h4>Jyothi Talari</h4>
      ...
      <div class="footer-founder-card">
        <div class="footer-avatar-container">
          <img src="https://mokshara.indevs.in/assets/devi.jpeg?v=1.3" alt="Devi" class="footer-avatar" onerror="this.style.display='none'"/>
        </div>
        <h4>Devi</h4>
