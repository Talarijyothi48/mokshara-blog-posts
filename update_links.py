      ...
      <div class="overlay-founder-profiles">
        <div class="overlay-founder-card">
          <div class="overlay-avatar-container">
            <img src="https://mokshara.indevs.in/assets/jyothi.jpeg?v=1.3" alt="Jyothi Talari" class="overlay-avatar">
          </div>
          <h4>Jyothi Talari</h4>
        ...
        <div class="overlay-founder-card">
          <div class="overlay-avatar-container">
            <img src="https://mokshara.indevs.in/assets/devi.jpeg?v=1.3" alt="Devi" class="overlay-avatar">
          </div>
          <h4>Devi</h4>
  ...
  about: `
    ...
    <div style="display: flex; gap: 1.5rem; flex-wrap: wrap; margin-top: 1.5rem;">
      <div style="flex: 1; min-width: 240px; text-align: center; background: rgba(0,128,128,0.03); padding: 1.5rem; border-radius: 12px; border: 1px solid rgba(0,128,128,0.1);">
        <img src="https://mokshara.indevs.in/assets/jyothi.jpeg?v=1.3" alt="Jyothi Talari" style="width: 80px; height: 80px; border-radius: 50%; border: 3px solid #D4AF37; object-fit: cover; object-position: center 20% !important; margin-bottom: 0.8rem; display: inline-block;">
      ...
      <div style="flex: 1; min-width: 240px; text-align: center; background: rgba(0,128,128,0.03); padding: 1.5rem; border-radius: 12px; border: 1px solid rgba(0,128,128,0.1);">
        <img src="https://mokshara.indevs.in/assets/devi.jpeg?v=1.3" alt="Devi" style="width: 80px; height: 80px; border-radius: 50%; border: 3px solid #D4AF37; object-fit: cover; object-position: center 20% !important; margin-bottom: 0.8rem; display: inline-block;">
