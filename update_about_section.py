    ...
    <div class="sidebar-widget author-widget">
      ...
      <div style="margin-bottom: 1.5rem; text-align: center;">
        <div style="width: 80px; height: 80px; margin: 0 auto 0.6rem; border-radius: 50%; border: 3px solid var(--gold); overflow: hidden; box-shadow: 0 4px 8px rgba(0,0,0,0.1);">
          <img src="https://mokshara.indevs.in/assets/jyothi.jpeg?v=1.2" alt="Jyothi Talari" style="width: 100%; height: 100%; object-fit: cover; object-position: center 20%;">
        </div>
      ...
      <div style="text-align: center;">
        <div style="width: 80px; height: 80px; margin: 0 auto 0.6rem; border-radius: 50%; border: 3px solid var(--gold); overflow: hidden; box-shadow: 0 4px 8px rgba(0,0,0,0.1);">
          <img src="https://mokshara.indevs.in/assets/devi.jpeg?v=1.2" alt="Devi" style="width: 100%; height: 100%; object-fit: cover; object-position: center 20%;">
        </div>
